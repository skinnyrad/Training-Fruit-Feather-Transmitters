...
//Center frequency must be in MHz with a frequency between 718MHz AND 1024MHz
float centerFrequency = 915.0;

//FOR OPTION 2 - Burst
//The burst center frequency must be in MHz with a frequency between 718MHz AND 1024MHz
...
//The start frequency for the spread in MHz between 718MHz AND 1024MHz
float startFrequency = 915.0;
//The stop frequency for the spread in MHz between 718MHz AND 1024MHz
...
//bound itself by. The limit is 1024MHz. The number must be in MHz.
